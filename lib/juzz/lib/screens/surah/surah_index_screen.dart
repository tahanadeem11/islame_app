...
import 'package:islame_app_new_design/juzz/lib/cubits/chapter/cubit.dart';
import 'package:islame_app_new_design/juzz/lib/models/chapter/chapter.dart';
import 'package:islame_app_new_design/juzz/lib/models/juz/juz.dart';
...
import 'package:islame_app_new_design/juzz/lib/utils/juz.dart';
...
import 'package:islame_app_new_design/juzz/lib/widgets/flare.dart';
...
class _SurahIndexScreenState extends State<SurahIndexScreen> {
  ...
  void initState() {
    ...
    chapters = chapterCubit.state.data?.cast<Chapter?>();
    super.initState();
  }
