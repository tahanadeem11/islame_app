...
class PrivayScreen extends StatefulWidget {
  const PrivayScreen({Key? key}) : super(key: key);

  @override
  State<PrivayScreen> createState() => _PrivayScreenState();
}

class _PrivayScreenState extends State<PrivayScreen> {
  @override
